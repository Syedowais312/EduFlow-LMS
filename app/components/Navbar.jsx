...
import { BookOpen, Search, Bell, Settings, User } from 'lucide-react';
      ...
      <div className="container mx-auto flex flex-wrap justify-between items-center p-4">
        ...
        <div className="flex items-center space-x-3">
          ...
          {teacher ? (
            ...
            <span className="text-2xl font-bold bg-gradient-to-r from-purple-500 to-blue-400 bg-clip-text text-transparent">
              ...
              <p className="text-sm text-grey-600">Prof. Smith</p>
            </div>
          ) : (
            <span className="text-2xl font-bold bg-gradient-to-r from-purple-500 to-blue-400 bg-clip-text text-transparent">
              EduFlow
        ...
        {teacher ? (
          <div className="mt-4 md:mt-0 flex items-center gap-4 flex-wrap">
            <div className="relative w-full sm:w-auto">
              ...
              <input
                ...
                className="w-full sm:w-64 pl-10 pr-4 py-2 bg-gray-100 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300"
              />
            </div>
          ...
          <div className="mt-4 md:mt-0 flex gap-3 flex-wrap">
            <button className="px-6 py-2 rounded-full border border-white/20 hover:bg-white/10 transition-all duration-300 hover:scale-105">
              Login
            </button>
